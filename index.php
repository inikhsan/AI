...
<head>
	...
	<title>Tes Golongan Darah</title>

	<link rel="stylesheet" href="css/nivo-slider.css" media="screen">
	<link rel="stylesheet" href="css/futurico-theme.css" media="screen">

	<style type="text/css">body{background:url(img/bg.png) repeat;color:#fff000;width:960px;margin:0px auto}.footer{margin-top:100px;text-align:center;color:#655;font:bold 14px Arial}.footer a{color:#999;text-decoration:none}#wrapper{padding: 50px 0 0 325px;}</style>
...
<div id="wrapper">
	...
	<div class="slider-wrapper futurico-theme">
		...
		<div id="slider" class="nivoSlider">
			...
			<img src="img/ikhsan.png" alt="" title="#caption1">
			
		</div>

		<div id="caption1" class="nivo-html-caption">
			<strong>Muhammad Nur Ikhsan</strong> <span></span> <em>1154087</em>.
		</div>
